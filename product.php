...
<!--content-->
	<div class="product">
		<div class="container">
			...
			<div class=" con-w3l">
                <?php 
                   $sql1="SELECT * FROM `product` where `category_id`='".mysqli_escape_string($conn,$_GET['id'])."'";
                   ...
                   <div class="col-md-3 pro-1">
                    <div class="col-m">
                        <a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
                            <img src="admin/<?=getProductIMG($conn,$fetch1['id'],"img")?>" class="img-responsive" alt="">
                        </a>
                        <div class="mid-1">
                            <div class="women">
                                <h6><a href="product_details.php?id=<?=$fetch1['id']?>"><?=getProduct($conn,$fetch1['id'],"name")?></a>(500 g)</h6>			
                            </div>
                            <div class="mid-2">
                                <p ><label>Rs.<?=getProduct($conn,$fetch1['id'],"mrp")?></label><em class="item_price">Rs.<?=getProduct($conn,$fetch1['id'],"selling_price")?></em></p>
                                    <div class="block">
                       ...
                       echo "<h1>Product not availble</h1>";
                   }
