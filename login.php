          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form role="form" action="login-process.php" method="POST">
                  <?php
                  if (isset($_GET['m'])) {
                      echo "<p style='color:red;padding:0px;'>Email or Password doesn't match</p>";
                  }
                  ?>
                <div class="form-group">
                  <input type="email" name="email" id="email" class="form-control input-sm" placeholder="Email Address"><span id="emailMsg"></span>
                </div>
